...
## 🏆 결론 (Conclusion)
<ul>
<li>제안 모델인 PRIS-RHP가 모든 비교모델 대비 가장 낮은 오차율을 기록하며 가장 우수한 성능을 달성함.</li>
<li>리뷰 텍스트 기반 TNN,HP-BERT 대비 메타데이터를 활용한 DMMN 성능이 더 우수했으며, 패치노트까지 반영한 PRIS-RHP가 최적의 성능을 달성함.</li>
</ul>
## 📜 License

본 프로젝트는 한성대학교 캡스톤디자인 수업에서 진행되었습니다.
